...
| Сервис      | Характер сервиса      | Целевая пиковая нагрузка приложения | CPU   | RAM    | Net        |
| ----------- | --------------------- | ----------------------------------- | ----- | ------ | ---------- |
| nginx       | SSL handshake (CPS)   | 200 000 RPS                         | 400   | 4 Тb   | 215 Gbit/s |
| API-Gateway | средняя бизнес-логика | 190 000 RPS                         | 1900 | 190 Tb | 210 Gbit/s |
| Messages    | средняя бизнес-логика | 115 000 RPS                         | 1150 | 115 Tb | 180 Gbit/s |
| Guilds      | легкое JSON API       | 30 000 RPS                          | 6     | 60 Mb  | 10 Gbit/s  |
| Chats       | легкое JSON API       | 20 000 RPS                          | 4     | 40 Mb  | 10 Gbit/s  |
| Users       | легкое JSON API       | 25 000 RPS                          | 5     | 50 Mb  | 10 Gbit/s  |
| Voice       | средняя бизнес-логика | 5 000 000 connections               | 1800 | 70 Gb  | 535 Gbit/s |


Определяем конфигурацию машин для каждого сервиса

| Сервис                  | Хостинг       | Конфигурация                         | Cores | Cnt | Покупка (1 шт) | Аренда/Амортизация |
| ----------------------- | ------------- | ------------------------------------ | ----- | --- | -------------- | ------------------ |
| nginx                   | own           | 2x6430/8x64GB/1xNVMe256Gb/2x25Gb/s   | 64    | 12  | $ 10 000       | $ 167              |
| API-Gateway             | own           | 1x6430/16x128GB/1xNVMe256Gb/2x25Gb/s | 64    | 100 | $ 40 000       | $ 667              |
| Messages                | own           | 1x6430/16x128GB/1xNVMe256Gb/2x25Gb/s | 64    | 80  | $ 40 000       | $ 667              |
| Voice                   | own           | 2x6430/2x16GB/1xNVMe256Gb/2x25Gb/s   | 64    | 42  | $ 8 500        | $ 141              |
| Guilds / Chats /  Users | Digital Ocean | Basic Plan 8xCPU/16GB                | 8     | 10  | -              | $ 12               |


Распределение ресурсов сервисов в оркестрации

| Сервис | CPU/r | CPU/l | RAM/r | RAM/l  | Cnt |
| ------ | ----- | ----- | ----- | ------ | --- |
| Guilds | 0.5   | 1     | 1 Gb  | 2.5 Gb | 24  |
| Chats  | 0.5   | 1     | 1 Gb  | 2.5 Gb | 24  |
| Users  | 0.5   | 1     | 1 Gb  | 2.5 Gb | 24  |
