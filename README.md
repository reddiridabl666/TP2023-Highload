...
| Регион           | Процент трафика | Кол-во датацентров | Распределение                           |
| ---------------- | :-------------: | :----------------: | --------------------------------------- |
| Северная Америка |       35        |         6          | 1 в Канаде, остальное равномерно по США |
| Южная Америка    |        5        |         1          | Бразилия                                |
| Европа           |       25        |         3          | Равномерное                             |
| Россия           |        5        |         1          | Центральная Россия                      |
| Азия             |       10        |         2          | 1 в Индии, 1 - произвольно              |
| Австралия        |        5        |         1          | -                                       |

Насчет Африки не уверен, насколько там с урбанизацией... Можно один датацентр поставить?   

Мб еще стоит 1 во Владивостоке? Кроме восточной России покроет Японию (там не настолько много пользователей)  

Китай не рассматриваем, т.к. там Discord заблокирован. 
