...
При допущении, что все датацентры одинаковы и 1 датацентр способен обрабатывать 5% трафика:

| Регион           | Процент трафика | Кол-во датацентров | Распределение                           |
| ---------------- | :-------------: | :----------------: | --------------------------------------- |
| Северная Америка |       35        |         7          | 1 в Канаде, остальное равномерно по США |
| Южная Америка    |       10        |         2          | Бразилия и Аргентина                    |
| Европа           |       25        |         5          | Равномерное                             |
| Россия           |        5        |         1          | Центральная Россия                      |
| Азия             |       10        |         2          | 1 в Индии, 1 - произвольно              |
| Австралия        |        5        |         1          | -                                       |
| Африка           |       10        |         2          | Равномерное                             |

### Схема балансировки

Предлагаю определять регион по latency, в рамках региона определять датацентр через BGP Anycast.
